---
name: audit-system
description: Run full system audit across all layers — validation, integration, code quality, config, skills. Use when asked to audit, check everything, or verify system health.
context: fork
model: sonnet
